...
Elm.String.Split.make = function (_elm) {
   ...
   var chunksOfRight = F2(function (k,s) {
      ...
      var chunksOfR = function (s$) {
         ...
         k2) > 0 ? A2($List._op["::"],
         A2($String.right,k,s$),
         chunksOfR(A2($String.dropRight,k,s$))) : A2($List._op["::"],
         A2($String.right,k,s$),
   ...
   var chunksOfLeft = F2(function (k,s) {
      var len = $String.length(s);
      return _U.cmp(len,k) > 0 ? A2($List._op["::"],
      A2($String.left,k,s),
      A2(chunksOfLeft,k,A2($String.dropLeft,k,s))) : _U.list([s]);
   });
   return _elm.String.Split.values = {_op: _op
...
Elm.Number.Format.make = function (_elm) {
   ...
   var prettyInt = F2(function (sep,n) {
      ...
      $String.fromChar(sep),
      A2($String$Split.chunksOfRight,3,$Basics.toString(ni)));
   ...
   var pretty = F3(function (decimals,sep,n) {
      ...
      _U.cmp(nshifti,0) < 0 ? A2(prettyInt,sep,0 - ni) : A2(prettyInt,
      sep,
      ni),
      A2($String.cons,
      _U.chr("."),
      A3($String.padLeft,decimals,_U.chr("0"),nfs)));
   });
   return _elm.Number.Format.values = {_op: _op
                                      ,pretty: pretty
                                      ,prettyInt: prettyInt};
};
Elm.Native.Effects = {};
...
Elm.Apis = Elm.Apis || {};
Elm.Apis.Github = Elm.Apis.Github || {};
Elm.Apis.Github.make = function (_elm) {
   "use strict";
   _elm.Apis = _elm.Apis || {};
   _elm.Apis.Github = _elm.Apis.Github || {};
   if (_elm.Apis.Github.values) return _elm.Apis.Github.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var decodeUserAvatarUrl = A2($Json$Decode._op[":="],
   "avatar_url",
   $Json$Decode.string);
   var getUserAvatarUrl = function (username) {
      ...
      username);
      return $Task.toMaybe(A2($Http.get,decodeUserAvatarUrl,url));
   };
   return _elm.Apis.Github.values = {_op: _op
                                    ,decodeUserAvatarUrl: decodeUserAvatarUrl
...
Elm.Css.make = function (_elm) {
   ...
   var pttrStyleNode = styleNode(css);
   return _elm.Css.values = {_op: _op
                            ,styleNode: styleNode
                            ,css: css
                            ,pttrStyleNode: pttrStyleNode};
};
Elm.Gui = Elm.Gui || {};
Elm.Gui.GridInput = Elm.Gui.GridInput || {};
Elm.Gui.GridInput.Cell = Elm.Gui.GridInput.Cell || {};
Elm.Gui.GridInput.Cell.make = function (_elm) {
   "use strict";
   _elm.Gui = _elm.Gui || {};
   _elm.Gui.GridInput = _elm.Gui.GridInput || {};
   _elm.Gui.GridInput.Cell = _elm.Gui.GridInput.Cell || {};
   if (_elm.Gui.GridInput.Cell.values)
   return _elm.Gui.GridInput.Cell.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "MouseDown": return $Basics.not(model);
         case "MouseEnter": return $Basics.not(model);
   ...
   return _elm.Gui.GridInput.Cell.values = {_op: _op
                                           ,init: init
                                           ,update: update
                                           ,view: view};
};
...
Elm.Matrix.make = function (_elm) {
   ...
   var mapListRows = F2(function (func,matrix) {
      var lists = toLists(matrix);
      return A2($List.map,func,lists);
   });
   var indexedMapListRows = F2(function (func,matrix) {
      var lists = toLists(matrix);
      return A2($List.indexedMap,func,lists);
   });
   var toArrays = function (matrix) {
      var height = $Basics.snd(matrix.size);
      var width = $Basics.fst(matrix.size);
   ...
   var mapArrayRows = F2(function (func,matrix) {
      var arrays = toArrays(matrix);
   ...
   return _elm.Matrix.values = {_op: _op
                               ...
                               ,indexedMap: indexedMap
                               ,filter: filter
                               ,mapArrayRows: mapArrayRows
                               ,mapListRows: mapListRows
                               ,indexedMapListRows: indexedMapListRows
                               ,toArrays: toArrays
                               ,toLists: toLists
                               ,Matrix: Matrix};
};
Elm.Gui = Elm.Gui || {};
Elm.Gui.GridInput = Elm.Gui.GridInput || {};
Elm.Gui.GridInput.Grid = Elm.Gui.GridInput.Grid || {};
Elm.Gui.GridInput.Grid.make = function (_elm) {
   "use strict";
   _elm.Gui = _elm.Gui || {};
   _elm.Gui.GridInput = _elm.Gui.GridInput || {};
   _elm.Gui.GridInput.Grid = _elm.Gui.GridInput.Grid || {};
   if (_elm.Gui.GridInput.Grid.values)
   return _elm.Gui.GridInput.Grid.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Gui$GridInput$Cell = Elm.Gui.GridInput.Cell.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      var _p1 = _p0._0;
      var cellModel = A2($Matrix.get,_p1.x,_p1.y);
      return A4($Matrix.update,
      _p1.x,
      _p1.y,
      $Gui$GridInput$Cell.update(_p0._1),
      model);
   });
   var CellAction = F2(function (a,b) {
      return {ctor: "CellAction",_0: a,_1: b};
   });
   var rowView = F3(function (address,y,row) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("row")]),
      A2($List.indexedMap,
      F2(function (x,cell) {
         return A2($Gui$GridInput$Cell.view,
   ...
   var view = F2(function (address,model) {
      ...
      A2($Matrix.indexedMapListRows,
      F2(function (y,row) {    return A3(rowView,address,y,row);}),
      model));
   });
   var allTrue = function (model) {
      return _U.eq($Array.length(A2($Matrix.filter,
      function (val) {
         return _U.eq(val,false);
      },
      model)),
      0);
   };
   var init = F2(function (width,height) {
      ...
      width,
      height,
      $Gui$GridInput$Cell.init(false));
   });
   return _elm.Gui.GridInput.Grid.values = {_op: _op
                                           ,init: init
                                           ,allTrue: allTrue
...
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Apis$Github = Elm.Apis.Github.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Gui$GridInput$Grid = Elm.Gui.GridInput.Grid.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var spinner = A2($Html.div,
   _U.list([$Html$Attributes.$class("sk-three-bounce")]),
   _U.list([A2($Html.div,
           _U.list([$Html$Attributes.$class("sk-child sk-bounce1")]),
           _U.list([]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("sk-child sk-bounce2")]),
           _U.list([]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("sk-child sk-bounce3")]),
           _U.list([]))]));
   var isUsernameValid = function (username) {
      return _U.cmp($String.length(username),2) > 0 ? true : false;
   };
   var leftPadIntString = F3(function (padChar,width,nString) {
      var padLength = width - $String.length(nString);
      return A2($Basics._op["++"],
      A2($String.repeat,padLength,$String.fromChar(padChar)),
      nString);
   });
   var leftPadFloatString = F3(function (padChar,width,nFloat) {
      var parts = A2($String.split,".",nFloat);
      var _p0 = parts;
      if (_p0.ctor === "::" && _p0._1.ctor === "::" && _p0._1._1.ctor === "[]")
      {
            return A2($Basics._op["++"],
            A3(leftPadIntString,padChar,width,_p0._0),
            A2($Basics._op["++"],".",_p0._1._0));
         } else {
            return _U.crashCase("Main",
            {start: {line: 273,column: 5},end: {line: 277,column: 58}},
            _p0)("This crash shouldn\'t be possible :)");
         }
   });
   var formatDuration = function (durationTenths) {
      var durationSeconds = $Basics.toFloat(durationTenths) / 10.0;
      var formatted = A3($Number$Format.pretty,
      1,
      _U.chr(","),
      durationSeconds);
      return A3(leftPadFloatString,_U.chr("0"),2,formatted);
   };
   var clockView = function (model) {
      var number = formatDuration(model.ticksElapsed);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("stopwatch")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("seconds")]),
              _U.list([$Html.text(number)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("seconds-label")]),
              _U.list([$Html.text("secs")]))]));
   };
   var tableRow = function (cellInnards) {
      var cellsHtml = A2($List.map,
      function (cellInnard) {
         return A2($Html.td,_U.list([]),_U.list([cellInnard]));
      },
      cellInnards);
      return A2($Html.tr,_U.list([]),cellsHtml);
   };
   var tableMaker = function (rows) {
      var rowsHtml = A2($List.map,
      function (row) {
         return A2($Html.tr,_U.list([]),_U.list([tableRow(row)]));
      },
      rows);
      return A2($Html.table,_U.list([]),rowsHtml);
   };
   var bestTimesListView = function (bestTimes) {
      var _p2 = bestTimes;
      if (_p2.ctor === "Just") {
            var sortedList = A2($List.map,
            function (bestTime) {
               return _U.list([A2($Html.span,
                              _U.list([$Html$Attributes.$class("duration")]),
                              _U.list([$Html.text(formatDuration(bestTime.duration))]))
                              ,function () {
                                 var _p3 = bestTime.avatarUrl;
                                 if (_p3.ctor === "Nothing") {
                                       return $Html.text("");
                                    } else {
                                       return A2($Html.img,
                                       _U.list([$Html$Attributes.src(_p3._0)]),
                                       _U.list([]));
                                    }
                              }()
                              ,$Html.text(bestTime.username)]);
            },
            A2($List.take,
            100,
            A2($List.sortBy,
            ...
            $Dict.values(_p2._0))));
            return tableMaker(sortedList);
         } else {
            return spinner;
         }
   };
   var dlHelper = F2(function (cssClass,items) {
      var dtHelper = function (_p4) {
         var _p5 = _p4;
         return _U.list([A2($Html.dt,
                        _U.list([]),
                        _U.list([$Html.text(_p5._0)]))
                        ,A2($Html.dd,_U.list([]),_U.list([$Html.text(_p5._1)]))]);
      };
      var ddItems = $List.concat(A2($List.map,dtHelper,items));
      return A2($Html.dl,
      _U.list([$Html$Attributes.$class(cssClass)]),
      ddItems);
   });
   var ClockTick = {ctor: "ClockTick"};
   var tenthSecondSignal = A2($Signal.map,
   function (_p6) {
      return ClockTick;
   },
   $Time.every($Time.millisecond * 100));
   var FromEffect = {ctor: "FromEffect"};
   var kickOff = function (_p7) {
   ...
   var StartAgain = {ctor: "StartAgain"};
   var gameProgressView = F2(function (address,gameProgress) {
      var message = function () {
         var _p8 = gameProgress;
         switch (_p8.ctor)
         {case "NotStarted": return A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("Move the cursor into the town area to start.")]));
            case "Playing": return A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("Don\'t stop until the town\'s fully red.")]));
            default: return A2($Html.p,
              _U.list([$Html$Attributes.$class("party-time")]),
              _U.list([A2($Html.div,
                      _U.list([]),
                      _U.list([$Html.text("Party time!")]))
                      ,A2($Html.a,
                      _U.list([$Html$Attributes.href("#")
                              ,A2($Html$Events.onClick,address,StartAgain)]),
                      _U.list([$Html.text("Play again?")]))]));}
      }();
      return A2($Html.p,_U.list([]),_U.list([message]));
   });
   var GotAvatar = F2(function (a,b) {
      return {ctor: "GotAvatar",_0: a,_1: b};
   });
   var SubmitBestTime = F2(function (a,b) {
      return {ctor: "SubmitBestTime",_0: a,_1: b};
   });
   var GithubUsernameUpdated = function (a) {
      return {ctor: "GithubUsernameUpdated",_0: a};
   };
   var currGithubUsernameInput = function (address) {
      return A2($Html.input,
      _U.list([$Html$Attributes.type$("text")
              ,$Html$Attributes.placeholder("your github username")
              ,A3($Html$Events.on,
              "input",
              $Html$Events.targetValue,
              function (v) {
                 return A2($Signal.message,address,GithubUsernameUpdated(v));
              })]),
      _U.list([]));
   };
   var submitBestTimeForm = F2(function (address,model) {
      return A2($Html.form,
      _U.list([A4($Html$Events.onWithOptions,
              ...
              function (_p9) {
                 ...
                 address,
                 A2(SubmitBestTime,model.currGithubUsername,model.ticksElapsed));
              })
              ,$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "valid"
                                                   ,_1: isUsernameValid(model.currGithubUsername)}]))]),
      _U.list([currGithubUsernameInput(address)
              ,A2($Html.input,
              _U.list([$Html$Attributes.type$("submit")
                      ,$Html$Attributes.value("Show the world!")]),
              _U.list([]))]));
   });
   var enterBestTimeView = F2(function (address,model) {
      var _p10 = model.gameProgress;
      if (_p10.ctor === "Finished") {
            return A2($Html.div,
            _U.list([$Html$Attributes.$class("submission")]),
            _U.list([A2($Html.p,
                    _U.list([$Html$Attributes.$class("well-done-text")]),
                    _U.list([$Html.text("Well Done! Enter your github username to enter your time in the Best Times leaderboard.")]))
                    ,A2(submitBestTimeForm,address,model)]));
         } else {
            return A2($Html.span,_U.list([]),_U.list([]));
         }
   });
   var scoresPanelView = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("scores-panel")]),
      _U.list([A2($Html.h2,
              _U.list([$Html$Attributes.$class("scores-heading")]),
              _U.list([$Html.text("Your Time")]))
              ,clockView(model)
              ,A2(enterBestTimeView,address,model)
              ,A2($Html.h3,_U.list([]),_U.list([$Html.text("Best Times")]))
              ,bestTimesListView(model.bestTimes)]));
   });
   var GridAction = function (a) {
      return {ctor: "GridAction",_0: a};
   };
   var gameView = F2(function (address,model) {
      var progressClass = function () {
         var _p11 = model.gameProgress;
         switch (_p11.ctor)
      ...
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "stage"
                                                   ,_1: true}
                                                  ,{ctor: "_Tuple2",_0: progressClass,_1: true}]))]),
      _U.list([A2($Gui$GridInput$Grid.view,
      A2($Signal.forwardTo,address,GridAction),
      model.grid)]));
   });
   var mainView = F2(function (address,model) {
      ...
      _U.list([A2($Html.h2,
              _U.list([]),
              _U.list([$Html.text("PAINT THE TOWN RED")]))
              ,A2(gameView,address,model)
              ,A2(gameProgressView,address,model.gameProgress)]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Css.pttrStyleNode
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("app")]),
              _U.list([A2(mainView,address,model)
                      ,A2(scoresPanelView,address,model)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("footer")]),
              _U.list([A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("Made with the ")
                      ,A2($Html.a,
                      _U.list([$Html$Attributes.href("http://elm-lang.org/")]),
                      _U.list([$Html.text("Elm programming language")]))
                      ,$Html.text(" by ")
                      ,A2($Html.a,
                      _U.list([$Html$Attributes.href("https://github.com/mbylstra")]),
                      _U.list([$Html.text("@mbylstra  |  ")]))
                      ,$Html.text(" Fantastic town illustration by ")
                      ,A2($Html.a,
                      _U.list([$Html$Attributes.href("https://www.flickr.com/photos/36106576@N05/3960016602")]),
                      _U.list([$Html.text("Don Moyer")]))]))]))]));
   });
   var BestTime = F3(function (a,b,c) {
      return {username: a,duration: b,avatarUrl: c};
   });
   var Model = F6(function (a,b,c,d,e,f) {
      return {grid: a
             ...
             ,gameProgress: c
             ,ticksElapsed: d
             ,currGithubUsername: e
             ,currAvatarUrl: f};
   });
   var BestTimeSubmitted = {ctor: "BestTimeSubmitted"};
   var Finished = {ctor: "Finished"};
   var Playing = {ctor: "Playing"};
   var NotStarted = {ctor: "NotStarted"};
   var init = F2(function (width,height) {
      return {grid: A2($Gui$GridInput$Grid.init,width,height)
             ,bestTimes: $Maybe.Nothing
             ,gameProgress: NotStarted
             ,ticksElapsed: 0
             ,currGithubUsername: ""
             ,currAvatarUrl: $Maybe.Nothing};
   });
   var firebaseUrl = "https://vivid-torch-4218.firebaseio.com/";
   var syncConfig = {location: $ElmFire.fromUrl(firebaseUrl)
                    ,orderOptions: $ElmFire.noOrder
                    ,encoder: function (bestTime) {
                       return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                                           ,_0: "username"
                                                           ,_1: $Json$Encode.string(bestTime.username)}
                                                          ,{ctor: "_Tuple2"
                                                           ,_0: "duration"
                                                           ,_1: $Json$Encode.$int(bestTime.duration)}
                                                          ,{ctor: "_Tuple2"
                                                           ,_0: "avatarUrl"
                                                           ,_1: function () {
                                                              var _p12 = bestTime.avatarUrl;
                                                              if (_p12.ctor === "Nothing") {
                                                                    return $Json$Encode.$null;
                                                                 } else {
                                                                    return $Json$Encode.string(_p12._0);
                                                                 }
                                                           }()}]));
                    }
                    ,decoder: A4($Json$Decode.object3,
                    BestTime,
                    A2($Json$Decode._op[":="],"username",$Json$Decode.string),
                    A2($Json$Decode._op[":="],"duration",$Json$Decode.$int),
                    $Json$Decode.maybe(A2($Json$Decode._op[":="],
                    "avatarUrl",
                    $Json$Decode.string)))};
   var _p13 = $ElmFire$Dict.mirror(syncConfig);
   var initialTask = _p13._0;
   var inputItems = _p13._1;
   ...
   var update = F2(function (action,model) {
      var _p14 = action;
      switch (_p14.ctor)
      {case "GridAction": var newGrid = A2($Gui$GridInput$Grid.update,
           _p14._0,
           model.grid);
           var newGameProgress = function () {
              var _p15 = model.gameProgress;
              switch (_p15.ctor)
              {case "NotStarted": return Playing;
                 case "Playing":
                 return $Gui$GridInput$Grid.allTrue(newGrid) ? Finished : Playing;
                 default: return model.gameProgress;}
           }();
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {grid: newGrid,gameProgress: newGameProgress})
                  ,_1: $Effects.none};
         case "ClockTick": var _p16 = model.gameProgress;
           if (_p16.ctor === "Playing") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{ticksElapsed: model.ticksElapsed + 1})
                        ,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              }
         case "GithubUsernameUpdated": return {ctor: "_Tuple2"
                                              ,_0: _U.update(model,{currGithubUsername: _p14._0})
                                              ,_1: $Effects.none};
         case "SubmitBestTime": var _p17 = _p14._0;
           var getAvatarTask = $Apis$Github.getUserAvatarUrl(_p17);
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {gameProgress: BestTimeSubmitted,currAvatarUrl: $Maybe.Nothing})
                  ,_1: $Effects.task(A2($Task.map,
                  GotAvatar(_p17),
                  getAvatarTask))};
         case "GotAvatar": var _p18 = _p14._0;
           return {ctor: "_Tuple2"
                  ,_0: model
                  ,_1: effectItems(A2($ElmFire$Op.insert,
                  _p18,
                  {username: _p18
                  ,duration: model.ticksElapsed
                  ,avatarUrl: _p14._1}))};
         case "StartAgain": return {ctor: "_Tuple2"
                                   ,_0: A2(init,10,10)
                                   ,_1: initialEffect};
         ...
         default: return A2($Debug.log,
           "FromServer",
           {ctor: "_Tuple2"
           ,_0: _U.update(model,{bestTimes: $Maybe.Just(_p14._0)})
           ,_1: $Effects.none});}
   });
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,Playing: Playing
                             ,Finished: Finished
                             ,BestTimeSubmitted: BestTimeSubmitted
                             ,Model: Model
                             ,BestTime: BestTime
                             ,init: init
                             ,GridAction: GridAction
                             ,GithubUsernameUpdated: GithubUsernameUpdated
                             ,SubmitBestTime: SubmitBestTime
                             ,GotAvatar: GotAvatar
                             ...
                             ,gameView: gameView
                             ,scoresPanelView: scoresPanelView
                             ,dlHelper: dlHelper
                             ,tableRow: tableRow
                             ,tableMaker: tableMaker
                             ,bestTimesListView: bestTimesListView
                             ,formatDuration: formatDuration
                             ,leftPadIntString: leftPadIntString
                             ,leftPadFloatString: leftPadFloatString
                             ,clockView: clockView
                             ,isUsernameValid: isUsernameValid
                             ,enterBestTimeView: enterBestTimeView
                             ,submitBestTimeForm: submitBestTimeForm
                             ,currGithubUsernameInput: currGithubUsernameInput
                             ,spinner: spinner
                             ...
                             ,config: config
                             ,app: app
                             ,tenthSecondSignal: tenthSecondSignal
                             ,main: main};
};
